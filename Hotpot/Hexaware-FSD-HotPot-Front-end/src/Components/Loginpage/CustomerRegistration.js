...
function CustomerRegistration() {
  ...
  const handlePasswordReset = async () => {
    const resetUsername = prompt("Please enter your username:");
    if (resetUsername) {
      const newPassword = prompt("Please enter your new password:");
      if (newPassword) {
        try {
          await axios.post('http://localhost:5249/api/Customer/reset-password', {
          ...
          {isLoginFormDisplayed ? (
            <div className="login-form">
              ...
              <form onSubmit={handleLoginSubmit}>
                ...
                <button className="forgot-password-btn btn btn-secondary" onClick={handlePasswordReset}>Reset Password</button>
              </form>

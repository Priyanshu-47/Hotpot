...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    const fetchOrderSummary = async () => {
      try {
        const orderSummaryResponse = await axios.get('http://localhost:5249/api/Customer/cart/1');
    ...
    const fetchAddress = async () => {
      try {
        const addressResponse = await axios.get('http://localhost:5249/api/Customer/address/1');
    ...
    const fetchReview = async () => {
      try {
        const reviewResponse = await axios.get('http://localhost:5249/api/Customer/review/3');
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      await axios.post('http://localhost:5249/api/Customer/create-orders/1');
